                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <select name="alphabate_id" class="form-control select2" style="width: 100%;">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($sub_category as $key=>$categories)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('staff/add-sub-category/sub_cat_id=').$categories->id.'/edit'}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
