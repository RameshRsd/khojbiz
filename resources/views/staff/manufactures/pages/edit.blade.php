...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('staff/list-clients')}}"><i class="fa fa-calendar-times-o"></i>Client List</a></li>
                                                    ...
                                                    <div class="form-group">
                                                        <select name="alpha_id" class="form-control select2" style="width: 100%;">
                                                            ...
                                                            @foreach($alpha as $alphabates)
                                                                <option value="{{$alphabates->id}}" @if($alphabates->id == $client->id)selected @endif>{{$alphabates->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
