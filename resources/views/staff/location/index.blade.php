                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title" style="display: block;">Location/Places <a href="{{url('staff/create-location')}}" class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus-circle"></i> Create New</a></h3>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($locations as $key=>$location)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('staff/locations').'/'.$location->id.'/edit'}}" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
