...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{url('staff/list-suppliers')}}"><i class="fa fa-calendar-times-o"></i>Suppliers List</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add   llll New Client</h3>
                            <h3 class="box-title pull-right" style="margin-right:5px;"><a href="{{url('staff/list-suppliers')}}" class="btn btn-primary btn-xs"><i class="fa fa-eye"></i> Suppliers List</a></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
