                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title" style="display: block;">Add Package <a href="{{url('admin/list-package')}}" class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus-circle"></i> Package Listing</a></h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    <option value="inactive" @if(old('status')=='inactive') selected @endif>Unpublised</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
