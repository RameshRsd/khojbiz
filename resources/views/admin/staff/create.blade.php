                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" name="ctn_no" class="form-control" placeholder="Citizenship card no.">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="ref_person" placeholder="Name of Reference Person">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control" name="ref_person_no" placeholder="Reference Person Contact No.">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" name="ref_person_address" placeholder="Reference Person Address">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
