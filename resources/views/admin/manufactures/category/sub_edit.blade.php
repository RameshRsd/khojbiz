...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Edit Sub Category of Manufacturers
            </h1>
            <ol class="breadcrumb">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>Category of Manufacturers</th>
                                    <th>Alphabets</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                            ...
                                            <div class="form-group">
                                                <select name="cat_id" class="form-control select2" style="width: 100%;">
                                                    ...
                                                    @foreach($category as $cat)
                                                        <option value="{{$cat->id}}" @if($sub_category->id == $cat->id) selected @endif>{{$cat->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <select name="alphabet_id" class="form-control select2" style="width: 100%;">
                                                    <option value="">Choose Alphabatbbbe</option>
                                                    @foreach($alpha as $alphabet)
                                                        <option value="{{$alphabet->id}}" @if($sub_category->cat_id == $alphabet->id) selected @endif>{{$alphabet->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </td>
