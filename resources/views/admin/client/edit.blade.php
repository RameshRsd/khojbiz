                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <select name="company_nature_id" id="company_nature_id" class="form-control select2" style="width: 100%;">
                                                            <option value="">Choose..</option>
                                                            @foreach($natures as $nature)
                                                                <option value="{{$nature->id}}" @if($nature->id == $client->company_nature_id)selected @endif>{{$nature->name}}</option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                </div>
