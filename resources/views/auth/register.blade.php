                        ...
                        <div class="block block-themed block-fx-shadow mb-0">
                            <div class="block-header bg-success">
                                ...
                                <div class="block-options">
                                    <a class="btn-block-option font-size-sm" href="javascript:void(0)" data-toggle="modal" data-target="#one-signup-terms">Already Sign Up? </a>
                                    <a class="btn-block-option" href="{{url('login')}}" data-toggle="tooltip" data-placement="left" title="Sign In">
                                    ...
                                    <form class="js-validation-signup" action="" method="POST">
                                        ...
                                        <div class="py-3">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-lg form-control-alt" value="{{old('name')}}" id="signup-username" name="name" placeholder="Username">
                                                {{ $errors->first('name') }}
                                            </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control form-control-lg form-control-alt" value="{{old('email')}}" id="signup-email" name="email" placeholder="Email">
                                                {{ $errors->first('email') }}
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-lg form-control-alt" value="{{old('password')}}" id="signup-password" name="password" placeholder="Password">
                                                {{ $errors->first('password') }}
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-lg form-control-alt" value="{{old('password_confirmation')}}" id="signup-password-confirm" name="password_confirmation" placeholder="Password Confirm">
                                                {{ $errors->first('password_confirmation') }}
                                            </div>
                                            <div class="form-group">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" name="terms" value="true" {{ !old('terms') ?: 'checked' }}>
