            ...
            <div class="col-lg-9">
                <div class="content-covered">
                    <div class="content-header">
                        <h5 class="alphabate-heading">Top Product Companies<hr></h5>
                    </div>
                                                ...
                                                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                    <div class="card-body">
                                                        ...
                                                        @foreach($alphas as $alpha)
                                                            <li><a href="{{url('search_product?alphabate=').$alpha->name}}" class="alphabate @if(request('alphabate')==$alpha->name) active @endif">{{$alpha->name}}</a></li>
                                                        @endforeach
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <ul class="content-title">
                                                                <li><a href="{{url('companyinfo').'/'.$client->slug}}" class="company_title"><i class="fa fa-building-o"></i> {{str_limit($client->product_name,20)}}</a></li>
