                ...
                <div class="content-wrapp">
                    <div class="content-covered">
                        <div class="content-header">
                            <h5 class="overview-heading left">Edit Service Details</h5>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <input type="text" name="name" value="{{$service->name}}" class="form-control" placeholder="Input Name of Service">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        ...
                                        <textarea name="details"  cols="30" id="details" rows="10" class="form-control editor1">{!! $service->details !!}</textarea>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
