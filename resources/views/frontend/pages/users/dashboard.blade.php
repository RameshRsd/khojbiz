            ...
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li>
                            <a class="nav-link d-flex justify-content-between align-items-center">Profile </a>
                        </li>
                        <li>
                            <a class="nav-link d-flex justify-content-between align-items-center">Product & Service</a>
                        </li>
                        <li>
                            <a class="nav-link d-flex justify-content-between align-items-center">Image Gallery </a>
                        </li>
                        <li>
                            <a class="nav-link d-flex justify-content-between align-items-center">Contact Us </a>
                        </li>
                    </ul>
                </div>
                <!-- END Side Navigation -->
