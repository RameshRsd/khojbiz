...
use App\BuySell\ProductWiseCategory;
...
class ProductController extends Controller
{
    public function index(){
        ...
        $title = 'Add Product';
        return view('admin.product.index',compact('title','alpha','category','districts','products'));
    }
    public function create(){
        ...
        $districts = District::all();
        $title = 'Add Product';
        return view('admin.product.create',compact('title','alpha','category','districts'));
    }
