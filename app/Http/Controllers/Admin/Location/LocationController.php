...
class LocationController extends Controller
{
    public function index(){
        ...
        return view('admin.location.location_place.index',compact('title','locations'));
    }
    public function create(){
        ...
        return view('admin.location.location_place.create',compact('title','location_categores','alpha','districts'));
    }
    public function store(Request $request){
        ...
        $location->save();
        return redirect('admin/locations')->with('success','Location Create Successfully !!');
    }
    public function edit($id){
        ...
        return view('admin.location.location_place.edit',compact('title','location_categores','alpha','districts','location'));
    }
    public function update(Request $request, $id){
        ...
        $location->save();
        return redirect('admin/locations')->with('success','Locaton Updated Successfully !!');
    }
}
