...
class ManufactureCompanyController extends Controller
{
    ...
    public function create(){
        ...
        return view('admin.manufactures.pages.create',compact('title','districts','category','alpha'));
    }
    public function store(Request $request){
        ...
        if ($user->save()){
            ...
            $client->save();
            return redirect('admin/category-wise-manufactures')->with('success','Client Created Successfully !');
        }
    }
