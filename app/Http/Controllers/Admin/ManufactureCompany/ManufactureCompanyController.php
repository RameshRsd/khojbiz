...
class ManufactureCompanyController extends Controller
{
    public function index(){
        ...
        $clients = Client::where('company_nature','manufacture')->orderBy('company_name','ASC')->get();
        $category = MenuCategory::orderBy('name','ASC')->get();
        return view('admin.manufactures.pages.index',compact('title','clients','category'));
    ...
    public function create(){
        ...
        return view('admin.manufactures.pages.create',compact('title','districts','categories','alpha'));
    }
    public function store(Request $request){
        ...
        if ($user->save()){
            ...
            return redirect('admin/list-manufacturers')->with('success','Client Created Successfully !');
        }
    }
    public function edit($id){
        ...
        return view('admin.manufactures.pages.edit',compact('title','districts','category','alpha','client'));
    }
    public function update(Request $request, $id){
        ...
        $client->save();
        return redirect('admin/category-wise-manufactures')->with('success','Client Updated Successfully !');
